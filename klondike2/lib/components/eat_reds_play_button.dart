...
/// Play button for Eat Reds game - executes the capture when both cards are selected
class EatRedsPlayButton extends RectangleComponent
  ...
  bool onTapDown(TapDownEvent event) {
    if (_enabled) {
      ...
      if (rules is EatRedsRules) {
        ...
        final success = rules.executePlay(world.foundations);
        if (success) {
          debugPrint('Play button pressed - capture executed successfully');
        }
      }
    }
    return true;
